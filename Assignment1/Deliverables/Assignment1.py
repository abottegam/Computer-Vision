...
class App(tk.Tk):
    ...
    def buildWindow(self):
        ...
        origLabel = tk.Label(self, text= "Original Image", font=("Arial", 30, "bold"), pady=10)
        previewLabel = tk.Label(self, text= "Preview Image", font=("Arial", 30, "bold"), pady= 10)
        origLabel.grid(row= 0, column=0, sticky= "N")
        previewLabel.grid(row=0, column=1, sticky= "N")
